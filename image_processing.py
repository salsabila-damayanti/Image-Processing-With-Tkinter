...
root.title("Image Processing (Salsabila Damayanti - 1207050114)")
...
def apply_filter(filter):
    ...
    elif filter == "Rotate 90" :
        image = image.rotate(90)
    elif filter == "Rotate 180" :
        image = image.rotate(180)
    elif filter == "Rotate 270" :
...
def savefile():
    global temp_file
    image_save = filedialog.asksaveasfilename(defaultextension=".jpg")
    ...
    if image_save :
        ...
        tk.messagebox.showinfo("Message", "Image Succesfully Saved !")
    else :
        tk.messagebox.showinfo("Message", "Image Not Saved !")
...
filter_combobox = ttk.Combobox(left_frame, values=["Black and White", "Blur",
                                             "Emboss", "Sharpen", "Smooth", "Flip", "Rotate 90", "Rotate 180", "Rotate 270"])
